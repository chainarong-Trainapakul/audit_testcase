...
<form name="form1" method="post" action="save_sale.php">
  เปลี่ยนแปลงเปอร์เซ็นที่ลดราคาค่าอาหาร <br>
  <div class="datagrid">
  <table>
    <tbody>
    
      <tr>
        <td> &nbsp;เปอร์เซ็นที่ลดราคา (%)</td>
        <td><input class="input" name="txtsale" type="number" id="txtsale">
        </td>
      </tr>
  ...
  <br />
  &nbsp;การลดราคาจะลดเฉพาะค่าอาหารเท่านั้น
  ...
  <input type="submit" name="Submit" value="Save">
   ...
   <form name="frmMain" method="post" action="showsale.php">
<button class="button button4">เรียกดูรายการเปลี่ยนแปลงส่วนลด</button>
</form>
