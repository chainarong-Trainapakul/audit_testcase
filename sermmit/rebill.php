...
mysql_connect("localhost","root","password");
    ...
    $sql = "SELECT * FROM ordertypecomplete WHERE order_id = '".$_GET["orderID"]."'";
...
<form action="reportmoney.php" name="frmEdit" method="post">
<table width="450" border="0" align="center">
 ...
 <tr>
  ...
  <tr>
      <td height="15" colspan="2" align="left">เล่มที่ :  <?php echo $row['bookid'] ?></td>
    </tr>
<tr>	
	  <td height="15" colspan="2" align="left"> เลขที่ :  <?php echo $row['bill_id'] ?> </td>
    <td height="15" colspan="2" align="right">วันที่ : <?php echo $row['orderdate'] ?></td>
...
<tr>
  ...
  <tr>
    <td height="15" colspan="4">ชื่อลูกค้า :<?php echo $row['namec'] ?>

	</td>
	
  </tr>
  <tr>
    <td height="15" colspan="4">ที่อยู่ : <?php echo $row['addc'] ?>
	</td>
  </tr>
...
while($objResult = mysql_fetch_array($objQuery))
{
	...
	$a = $objResult["SUM(price_sum)"];
	$b = $objResult["SUM(numfood)"];
...
// $s = $_POST["txtsale"];
 ...
 ?>
  ...
  <tr>
  <td align="left" colspan="4">&nbsp;(รวมภาษีมูลค่าเพิ่ม)</td>
